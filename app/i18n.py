...
ZH = {
    ...
    "Search Jobs": "搜索职位", "Add Job": "添加职位", "Import": "导入", "Analyze Selected": "分析所选职位", "Resume Drafts": "简历草稿", "Cover Drafts": "求职信草稿", "Current status": "当前状态", "Cancel": "取消", "Interested jobs": "感兴趣的职位", "Generate Resume Draft": "生成简历草稿", "Generate CV Draft": "生成 CV 草稿", "Resume setup  ▸": "简历设置  ▸", "Resume setup  ▾": "简历设置  ▾",
    "Open Job Page": "打开职位网页", "Translate 中文": "翻译为中文", "Show Chinese": "显示中文", "Original text": "原文",
    "Open Selected PDF": "打开所选 PDF", "Open Selected DOCX": "打开所选 DOCX", "Open Selected File…": "打开所选文件…", "Open PDF": "打开 PDF", "Open Word document": "打开 Word 文档", "Approve Version": "批准版本", "Reject Version": "拒绝版本", "Cover Letters": "求职信",
