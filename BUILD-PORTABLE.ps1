...
$buildRoot = Join-Path $projectRoot "build\portable-v030"
$distRoot = Join-Path $projectRoot "release\portable-v030"
...
$zip = Join-Path (Join-Path $projectRoot "release") "CareerOS-Portable-unsigned-v0.3.0.zip"
